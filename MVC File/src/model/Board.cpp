 ...
 *   Recursion behaviour is identical to the original C code.
 *
...
/* ============================================================
   ...
   Returns true  → cell was a mine  (Controller triggers game-over).
...
bool Board::revealCell(int row, int col)
{
    ...
    /* tell the Controller whether this was a mine */
...
/* ============================================================
   ...
   soundCallback — function pointer provided by Controller so we
   can play the click sound for every auto-revealed cell without
   Board depending directly on Raylib.
   ============================================================ */
                                      ...
                                      void (*soundCallback)())
{
    for (int rowOffset = -1; rowOffset <= 1; rowOffset++)
    {
        for (int colOffset = -1; colOffset <= 1; colOffset++)
        {
            ...
            /* play click sound for every auto-revealed cell */
...
/* ============================================================
   ...
   Used by the Controller to check the win condition.
   ============================================================ */
...
/* ============================================================
   ...
   Used by the View to read cell state for drawing.
   ============================================================ */
